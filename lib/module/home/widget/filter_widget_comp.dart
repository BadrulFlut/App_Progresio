...
class FilterWidgetCompHome extends StatefulWidget {
  double width;
  VoidCallback button;
  FilterWidgetCompHome({super.key, required this.width, required this.button});

  @override
  State<FilterWidgetCompHome> createState() => _FilterWidgetCompHomeState();
}

class _FilterWidgetCompHomeState extends State<FilterWidgetCompHome> {
  bool isChecked = true;
  var date1 = "";
  var date2 = "";
  check() {
